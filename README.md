<div align="center">
  <img src="frontend/src/assets/LINKLOCK-banner.png" alt="LINKLOCK Banner - Website Safety and Phishing Detection" width="100%" style="max-width:800px; border-radius:18px; margin:18px 0; box-shadow:0 4px 32px #00d4aa22;"/>
  <p>
...
LINKLOCK is a modern, user-friendly web application that helps users identify potentially malicious websites and phishing attempts. Built with React and TypeScript, it leverages Google's Safe Browsing API to provide real-time threat analysis and comprehensive security reports.
...
- <img src="https://github.com/tbhvishal/LINKLOCK/blob/main/frontend/src/assets/500x500.png?raw=true" width="18"/> **Real-time Threat Detection**: Instant analysis using Google's Safe Browsing API
...
1. **<img src="https://api.iconify.design/mdi:download.svg?color=%233b82f6" width="16"/> Clone the repository**
  ```bash
  git clone https://github.com/tbhvishal/LINKLOCK.git
  cd LINKLOCK
  ```
...
4. **Get help:**
   - Check [GitHub Issues](https://github.com/tbhvishal/LINKLOCK/issues)
...
- <img src="https://api.iconify.design/mdi:bug-check-outline.svg?color=%23ef4444" width="18"/> **Bug Reports**: [GitHub Issues](https://github.com/tbhvishal/LINKLOCK/issues)
- <img src="https://api.iconify.design/mdi:lightbulb-on-outline.svg?color=%23f59e0b" width="18"/> **Feature Requests**: [GitHub Issues](https://github.com/tbhvishal/LINKLOCK/issues)

## <img src="https://api.iconify.design/mdi:heart.svg?color=%23ef4444" width="24"/> Support



If you find LINKLOCK helpful, please consider:
...
<div align="center">
  <p><strong>Made with <img src="https://api.iconify.design/mdi:heart.svg?color=%23ef4444" width="16"/> by SHAKSHI PANDEY</strong></p>

---

<div align="center">
  <p><strong><img src="https://github.com/tbhvishal/LINKLOCK/blob/main/frontend/src/assets/500x500.png?raw=true" width="24"/> Stay Safe Online with LINKLOCK <img src="https://github.com/tbhvishal/LINKLOCK/blob/main/frontend/src/assets/500x500.png?raw=true" width="24"/></strong></p>
