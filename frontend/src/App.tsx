...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/40 to-blue-50/60 dark:from-slate-900 dark:via-gray-900 dark:to-zinc-900 transition-all duration-500 relative overflow-hidden" role="application" aria-label="LINKLOCK Phishing Detection Application">
