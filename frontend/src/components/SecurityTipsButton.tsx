...
const SecurityTipsButton = () => {
  ...
  const securityTips = [
    ...
    },
    {
      ...
      description: 'Always check suspicious URLs with LINKLOCK before visiting. Don\'t click links from unknown sources or unexpected emails.',
            ...
            <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-2xl shadow-xl border border-gray-200/50 dark:border-gray-700/50 p-6">
              ...
              >
                ...
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                  Use LINKLOCK before visiting any suspicious link. Our advanced analysis combined with Google's Safe Browsing provides the most comprehensive protection available.
                </p>
              </motion.div>
